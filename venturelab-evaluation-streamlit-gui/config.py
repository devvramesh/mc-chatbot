...
3. **Evaluation Criteria Scoring Stage**
    ...
    - If the user's comments are vague, lack depth, have a contradiction, have weak justification, or are unclear, tell them about the issue, and ask specific probing questions that clarify them. For example: 
