            ...
            if self.ai_company == 'anthropic': 
                messages.append({
                    ...
                    'content': [
                        ...
                        {
                            'type': 'text', 
                            'text': 'The evaluator has attached the following pitch deck to provide you with additional context. You do not need to acknowledge receipt of this document.'
                        }
                    ]
                })
